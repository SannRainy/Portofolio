...
// Drop the compiled PDF here: public/CV_ATS_KRISNA SATYA ARISANDY.pdf
const RESUME_PATH = "/CV_ATS_KRISNA SATYA ARISANDY.pdf";
      ...
      <div className="mx-auto flex w-full max-w-4xl flex-1 items-center justify-center px-2 pb-6 md:items-start md:px-4 md:pb-24">
        ...
        >
          <ResumeDoodle
            ...
            title="Krisna Satya Arisandy — Résumé"
          />
        </motion.div>
      </div>
    </div>
