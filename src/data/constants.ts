...
export const EXPERIENCE: Experience[] = [
  {
    ...
    company: "CV AMINS PROJECT TEKNOLOGI INDONESIA",
    description: [
      "Mengembangkan platform Brielle, sistem bug tracking dan manajemen proyek klien berbasis web menggunakan React, JavaScript, dan Tailwind CSS.",
      "Mengimplementasikan fitur pelaporan isu secara real-time yang terintegrasi langsung dengan sistem notifikasi otomatis WhatsApp API.",
      "Memberikan pembaruan status secara instan kepada admin, klien, dan developer guna mempercepat respon serta efisiensi alur penyelesaian kendala proyek.",
    ],
    skills: [
      SkillNames.REACT,
      SkillNames.JS,
